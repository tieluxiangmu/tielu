...
<td>
{%$data[$i]['foundproblem']|truncate:40|f_escape_xml%}
</td>
<td>
{%$data[$i]['categorynumber']|f_escape_xml%}
</td>
<td>
<a href="" class="edit"  data-editinfo='{"page":"realinvestigation/editcadrerealistic","id":{%$data[$i]["id"]|f_escape_xml%}}'  title="写实修改">
<img src="/web/static/cadrerealistic/images/icons/pencil_2d05354.png" alt="编辑" />
</a>
<a href="" title="写实删除"   data-deleteinfo='{"channelid":"realinvestigation-form","page":"realinvestigation/delete","id":{%$data[$i]["id"]|f_escape_xml%}}' class="delete">
<img src="/web/static/cadrerealistic/images/icons/cross_bc68ad4.png"  alt="删除" />
</a>
<a href="" title="写实详情"  class="detail"  data-detailinfo='{"page":"realinvestigation/view","id":{%$data[$i]["id"]|f_escape_xml%}}'>
