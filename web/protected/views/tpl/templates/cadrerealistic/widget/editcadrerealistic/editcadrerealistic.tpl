...
<tr>
<td>考核扣分</td>
<td colspan="3"><input  class="text-input small-input"  name="Realinvestigation[evaluationpoints]" id="Realinvestigation_evaluationpoints" value="{%$model['evaluationpoints']|f_escape_xml%}"  type="number" /></td>
</tr>
<tr>
<td>扣分原因</td>
