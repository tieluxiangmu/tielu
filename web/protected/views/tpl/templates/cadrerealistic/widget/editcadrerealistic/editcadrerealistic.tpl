...
<td colspan="3"><input name="Realinvestigation[categorynumber]" id="Realinvestigation_categorynumber"  class="text-input large-input" value="{%$model['categorynumber']|f_escape_xml%}"/></td>
</tr>
</tbody>
</table>
