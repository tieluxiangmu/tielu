  ...
  <div class="content-box-content">
    <div class="tab-content default-tab" id="tab1">
      <form class="search" id="ecurityprodu">
        <fieldset>
          <p>
            <span class="spantitle" style="padding-left:12px">检查时间 </span>
          ...
          <p>
            <span class="spantitle" style="padding-left:12px">按检查单位 </span>
            ...
            <span class="spantitle" style="padding-left:12px">按车站 </span>
            <select class="small-input chosen-select" multiple="multiple" id="company">
                            <option value="段领导">段领导</option>
                            <option value="安全科">安全科</option>
                            <option value="技信科">技信科</option>
          ...
          <p>
            <span class="spantitle" style="padding-left:12px">按检查人 </span>
...
{%script%}
require("produsearch.js").init('{%$urlparam%}');
{%/script%}