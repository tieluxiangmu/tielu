  ...
  <form id="realinvestigation-form" action="index.php?r=realinvestigation/Update&id={%$id%}" method="post" data-isneedrefresh="need">
        <table class="table table-bordered">
              <tbody>
                ...
                <tr>
                  <td>考核扣分</td>
                  <td colspan="3">  <input  class="text-input small-input"  name="Realinvestigation[evaluationpoints]" id="Realinvestigation_evaluationpoints" value="{%$model['evaluationpoints']%}" /></td>
                </tr>
                <tr>
                  <td>扣分原因</td>
