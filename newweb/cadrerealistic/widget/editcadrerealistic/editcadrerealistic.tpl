  ...
  <form id="realinvestigation-form" action="index.php?r=realinvestigation/Update&id={%$id%}" method="post" data-isneedrefresh="need">
        <table class="table table-bordered">
              <tbody>
                ...
                <tr>
                  <td>考核扣分</td>
                  <td colspan="3">  <input  class="text-input small-input"  name="Realinvestigation[evaluationpoints]" id="Realinvestigation_evaluationpoints" value="{%$model['evaluationpoints']%}"  type="number" /></td>
                </tr>
                <tr>
                  <td>扣分原因</td>
                  <td colspan="3"><input name="Realinvestigation[pointsreasons]" id="Realinvestigation_pointsreasons" class="text-input small-input" type="text"   value="{%$model['pointsreasons']%}"/></td>
                </tr>
                <tr>
                  <td>考核主体</td>
                  <td colspan="3"> <input type="text"   value="{%$model['assessmentmain']%}" class="text-input small-input"  name="Realinvestigation[assessmentmain]" id="Realinvestigation_assessmentmain" cols="79" rows="5"></input></td>
                </tr>
                <tr>
                  <td>评语</td>
                  <td colspan="3"> <textarea   name="Realinvestigation[comment]" id="Realinvestigation_comment"  cols="79" rows="5">{%$model['comment']%}</textarea></td>
                </tr>
                 <tr>
